function [index_reduced] = do_dct(obj,mpar, level)
...
X1 = mydct(obj,1); % do dct-transformation
X2 = mydct(X1,2); % do dct-transformation
X3 = mydct(X2,3); % do dct-transformation
