% Aiyagari1_sim2.m: Simulate decision rules of agents in Deaton-Huggett-Aiyagari model
...
wait_time = waitbar(0,'Please wait, calculating decision rules');
...
for i = 1:N
    ...
    for t = 2:T
        ...
        Sdec_squeezed = squeeze(Sdec(sZ(i,t),:)) ;
